...
*******************************************************************************
type logitfe.ado
*! logitfe v2.0.2 mgonza 25jan2015
...
B					= mean(((((logcdf(index) - L1 * lpsi - L2 * l2psi - ///
					  L3 * l3psi - L4 * l4psi) :* ws :* resx)' * FE) :/ (ws' * FE))' :/ TNp)
...
B					= (1/2) * mean((((-date :* pdate + ws:* rdate :* (2 * L1 * lpsi + ///
...
for (i = 1; i <= k; i ++) {
	...
	if ((min(x2p[.,i]) == 0 :| max(x2p[.,i]) == 1) :& rows(uniqrows(x2p[.,i])) == 2) {
		...
		pdate		= X1 * delta
		rdate		= (date :/ ws) - X1 * delta
		B			= (1/2) * mean((((-logpdf(index) :* (1 :- 2 * logcdf(index)) :* pdate + ws:* rdate :* (2 * L1 * lpsi + ///
					  2 * L2 * l2psi + 2 * L3 * l3psi + 2 * L4 * l4psi) + ddate)' * FE) :/ (ws' * FE))' :/ TNp)
